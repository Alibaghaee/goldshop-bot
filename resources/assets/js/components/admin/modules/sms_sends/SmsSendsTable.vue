...
// Vue.component('sms-send-custom-actions', require('./CustomActions'))
Vue.component('sms-send-detail', require('./DetailRow'))
...
export default {
  ...
  data () {
    return {
      ...
      apiUri: '/sms_sends/sms_sends',
      detailComponentName: 'sms-send-detail',
      sortOrder: [
        {
          sortField: '_id',
          direction: 'desc'
