    ...
    <div>
      <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            <div class="text-pink" v-if="form.errors.has('province.id')" v-text="form.errors.get('province.id')"></div>
          </div>
      </div>

      <transition name="fade">
      <div class="md:flex md:items-center mb-6" v-if="cities.length">
          <div class="md:w-1/4">
          ...
          <div class="md:w-2/3">
            ...
            <div class="text-pink" v-if="form.errors.has('city.id')" v-text="form.errors.get('city.id')"></div>
          </div>
      </div>
      </transition>
