    ...
    <div class="w-full">
        ...
        <div class="flex flex-row flex-wrap">
            <div class="w-full max-w-md">
                ...
                <div class="text-center text-bold py-1" >پنل ادمین</div>
                <div>
                    <img class="w-full mb- mb-8 " src="/image/admin/logo.png" alt="logo" style="max-height: 20rem;">
                </div>
                    ...
                    <div class="md:flex md:items-center">
                      ...
                      <div class="md:w-2/3">
                        <slot name="submit">
                            ...
                            <button class="mb-2 rhc-btn rhc-btn-blue" type="submit">
