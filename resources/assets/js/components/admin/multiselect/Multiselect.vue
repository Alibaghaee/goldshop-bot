    ...
    <div
        ...
        <transition name="multiselect">
            <div
              ...
              <span class="multiselect__option">
                <slot name="noResult">موردی یافت نشد، متن جستجو رو تغییر دهید.</slot>
              </span>
                    </li>
...
export default {
    ...
    props: {
        ...
        selectLabel: {
            type: String,
            default: 'برای انتخاب اینتر کنید'
        },
        /**
         * String to show when pointing to an option
         * @default 'Press enter to select'
        ...
        selectGroupLabel: {
            type: String,
            default: 'برای انتخاب گروه اینتر کنید'
        },
        /**
        ...
        deselectGroupLabel: {
            type: String,
            default: 'برای لغو انتخاب گروه اینتر کنید'
        },
        /**
