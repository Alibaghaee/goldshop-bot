...
export default {
  ...
  methods: {
    ...
    updateSubscription (subscription) {
      ...
      axios.post(genrateAddress('subscriptions'), data)
    ...
    deleteSubscription (subscription) {
      ...
      axios.post(genrateAddress('subscriptions/delete'), { endpoint: subscription.endpoint })
        .then(() => { this.loading = false })
    },
    ...
    sendNotification () {
      ...
      axios.post(genrateAddress('notifications'))
