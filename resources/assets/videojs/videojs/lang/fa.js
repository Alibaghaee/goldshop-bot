videojs.addLanguage("fa",{
  ...
  "Zoom": "بزرگنمایی",
  "reset": "بازنشانی تنظیمات",
  "ZOOM HELP": "کمک بزرگنمایی",
  "Use ZOOM slider or mouse wheel to ZOOM in video.": "از اسلایدر zoom یا چرخ موس برای zoom در ویدئو استفاده کنید.",
  "Drag zoomed area using your mouse or a finger.": "با استفاده از موس یا لمس ویدئو میتوانید محل بزرگنمایی را جابجا کنید",
  "Forward": "جلو انداختن",
  "Rewind":  "بازگرداندن",
  "Normal":  "عدای",
  "Mirror view": "حالت آینه",
  "Theater mode": "حالت تئاتر",
  "Advertisement": "تبلیغات ",
  "Skip Ad in": "رد کردن تبلیغ بعد از",
  "Skip Now!": "رد کن!",
  "Watch full video on": "Watch full video on" ,
  "Casting to": "Casting to",
  "Skip in %%TIME%% seconds": "در کردن بعد از %%TIME%% ثانیه",
  "Skip ad": "رد کردن تبلیغ",
  "Snapshot": "Snapshot"
});
