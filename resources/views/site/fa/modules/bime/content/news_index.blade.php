    ...
    <section class="  pb-16   mb-32  bg-end-page2 bg-cover bg-white">
        ...
        grid grid-cols-10">
            ...
            <div class="col-span-10 lg:col-span-6       mx-2 ">
                ...
                @include('site.fa.modules.bime.content.top_nav',['categories'=>$categories])
                        ...
                        @forelse($contents as $content)
                            ...
                            @if($conter===1)
                                ...
                                <div class="col-span-2 lg:col-span-2">
                                    ...
                                    <div
                                        onclick="window.location.href='{{route('content.show',['local'=>'fa','content'=>$content->id,])}}'"
                                        ...
                                        <div
                                            class="absolute text-white font-bold h-12 text-xs p-2 w-full  cursor-pointer bg-black bg-opacity-50 "
                            ...
                            @elseif($conter >=2 && $conter<=5)
                                <div
                                    ...
                                    <div class="p-2 flex flex-col justify-around h-1/2" style="min-height: 2rem;">
                                        <a href="{{route('content.show',['local'=>'fa','content'=>$content->id,])}}"
                                           class="block p-1 text-black    font-bold text-xs ">
                                            {{$content->title}}
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex flex-col justify-between mt-4">
                                            ...
                                            <span
                                                class="text-gray-400 text-xs border-b-2 border-blue-500">{{ $content->created_at_fa }}</span>
                                            </div>
