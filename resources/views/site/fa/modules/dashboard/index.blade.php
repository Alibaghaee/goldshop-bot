...
{{--                            دریافت اپلیکیشن--}}
{{--                        </button>--}}
                        <a href="tel:02188679017"
                            class="rounded-lg block border-2 border-primary text-primary px-2 py-3 md:px-8  md:px-8   ">
                            دریافت شماره تماس
                        </a>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper gap-0 " >
                            @foreach($slider->items as $item)
                                ...
                                <div class="swiper-slide flex-col px-4  border-l border-blue-darker " >
                                    ...
                                    <h5 class="text-primary text-xl">{{$item->title}}</h5>
                                </div>
                            @endforeach
                        </div>
                    </div>
...
{{--                <news-event :items="{{$newsEvent->items}}"></news-event>--}}
                <!-- blog cards -->
                <div class="newsSwiperMain flex gap-12 py-6  ">
                    <div class="relative ">
                    ...
                    <div class="swiper newsSwiper " style="padding-top: 3rem;">
                        <div class="swiper-wrapper gap-2 ">
                            @foreach($newsEvent->items as $item)
                                    ...
                                    <div class=" flex flex-col rounded-md overflow-hidden bg-white "
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="flex justify-between mt-4 text-xs">
                                                <span style="color: #0891b2;">{{ $item->created_at_fa }}</span>
                                                <a href="{{$item->link}}"
                                                   class=" cursor-pointer text-xs" style="color: #0ba2d4;">بیشتر بخوانید</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <a class="block float-left text-cyan-600 my-auto " href="{{route('content.index',['locale'=>'fa'])}}">
                    مطالب بیشتر
    ...
    <!-- services -->
    <section class="h-[300px] md:h-[400px]   flex relative">
            ...
            <div class="container  absolute inset-0 mt-20 md:mt-24  flex-col ">
              ...
              >
                  {!! $counseling->description !!}
                            ...
                            <button
                                class="rounded-lg border-2 text-white border-white text-wborder-white px-2 py-3 md:px-8 inline-block">
                                مشاوره رایگان خدمات بیمه اى
                            </button>
                        </div>
                    </div>
