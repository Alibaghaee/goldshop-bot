    ...
    <div class="flex flex-wrap flex-col-reverse md:flex-row">
        ...
        <div class="w-full md:w-2/3 px-4 py-8">
            <div class="w-full max-w-sm mx-auto">
                ...
                <div class="text-center md:text-right text-2xl md:text-3xl font-medium text-purple-darkest mb-8 w-full">ورود به حساب کاربری با رمز یکبار مصرف</div>

                <login-form-component action="{{ route('otp.login', app()->getLocale()) }}" method="post" submit_text="@lang('Login')">
