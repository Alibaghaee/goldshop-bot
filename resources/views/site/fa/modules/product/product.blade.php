<div class="w-full md:w-1/3 px-0 mb-6 md:px-2">
    <div class="bg-white border border-grey-lightest flex flex-wrap rounded">
        <div class="flex justify-center items-center w-full">
            @if($product->image)
                <a href="{{ $product->product_show_page }}" class="w-full">
        ...
        <div class="flex flex-col p-3 px-4 rounded w-full border-b-2 border-grey-lightest">
            <div class="flex flex-col py-3 border-b-2 border-grey-lighter w-full">
                ...
                {{-- <div class="text-green font-medium">{{ number_format($product->price) }} ریال</div> --}}
            </div>
            <div class="py-3 border-b-2 border-grey-lightest">{!! $product->detail_substr !!}</div>
