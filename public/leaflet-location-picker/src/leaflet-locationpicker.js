			...
			return L.marker( parseLocation(loc) || L.latLng(0,0), {
				icon: L.divIcon({
					...
					html: '<div style="position: relative; top: -1px; left: -1px; padding: 0px; margin: 0px; cursor: crosshair;'+
							...
							'<div style="width: 50%; height: 0px; left: +115%; border-top:  2px solid #274bc0;' + css + '"></div>'+
							'<div style="width: 50%; height: 0px; left:  30%; border-top:  2px solid #274bc0;' + css + '"></div>'+
							'<div style="width: 0px; height: 50%; top:   30%; border-left: 2px solid #274bc0;' + css + '"></div>'+
							'<div style="width: 0px; height: 50%; top:  -70%; border-left: 2px solid #274bc0;' + css + '"></div>'+
						'</div>',
				})
			});
		}
