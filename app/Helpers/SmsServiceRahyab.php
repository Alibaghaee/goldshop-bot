...
class SmsServiceRahyab
{
    public $company;
    public $host;
    public $port;

    public function __construct($company, $host, $port)
    {
    ...
    public function C2Unicode($uMessage)
    {
    ...
    public function DecodeUCS2($Content)
    {
    ...
    public function run_command($username, $password, $xml)
    {
        $ch = curl_init();
